          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            <div className="border-t border-[#3d484f]/20 p-8">
              <span className="mb-4 block text-xs uppercase tracking-[0.18em] text-[#70d2ff]">
                {homepageCopy.technicalSpecs.columns[0].label}
              </span>
              <h4 className="mb-4 text-xl font-bold">
                {homepageCopy.technicalSpecs.columns[0].title}
              </h4>
              <p className="text-sm leading-relaxed text-[#bdc8d0]">
                {homepageCopy.technicalSpecs.columns[0].body}
              </p>
            </div>
            <div className="border-t border-[#3d484f]/20 p-8">
              <span className="mb-4 block text-xs uppercase tracking-[0.18em] text-[#70d2ff]">
                {homepageCopy.technicalSpecs.columns[1].label}
              </span>
              <h4 className="mb-4 text-xl font-bold">
                {homepageCopy.technicalSpecs.columns[1].title}
              </h4>
              <p className="text-sm leading-relaxed text-[#bdc8d0]">
                {homepageCopy.technicalSpecs.columns[1].body}
              </p>
            </div>
            <div className="border-t border-[#3d484f]/20 p-8">
              <span className="mb-4 block text-xs uppercase tracking-[0.18em] text-[#70d2ff]">
                {homepageCopy.technicalSpecs.columns[2].label}
              </span>
              <h4 className="mb-4 text-xl font-bold">
                {homepageCopy.technicalSpecs.columns[2].title}
              </h4>
              <p className="text-sm leading-relaxed text-[#bdc8d0]">
                {homepageCopy.technicalSpecs.columns[2].body}
              </p>
            </div>
          </div>
        </div>
